 ...
 */
import { AlphaEntry, AngleEntry, BasicShapeFunctions, BoxEntry, ColorEntry, ColorFunctions, GeometryBoxEntry, ImageFunctions, IntegerEntry, LengthEntry, LineStyleEntry, LineWidthEntry, PercentEntry, PositionEntry, RepeatStyleEntry, StringEntry, StyleObject, TimeEntry, TransitionTimingFunctions, URLEntry, WideEntry } from "./index";
import { attr, blur, brightness, contrast, counter, dropShadow, grayscale, hueRotate, invert, matrix, matrix3d, minmax, opacity, path, perspective, repeat, rotate, rotate3d, rotateX, rotateY, rotateZ, saturate, scale, scale3d, scaleX, scaleY, scaleZ, sepia, skew, skewX, skewY, translate, translate3d, translateX, translateY, translateZ, url } from "helpers/funcs";
...
export interface CSSDecls {
  ...
  animation: {
    ...
    "reverse": StyleObject,
  } & { [value: number]: StyleObject } & TimeEntry & TransitionTimingFunctions & WideEntry
  /**
  ...
  } & URLEntry & LengthEntry & PercentEntry & { [value: number]: StyleObject } & WideEntry
  /**
  ...
  borderImageSlice: {
    /** Causes the middle part of the border-image to be preserved. */
    "fill": StyleObject,
  } & PercentEntry & { [value: number]: StyleObject } & WideEntry
  /**
  ...
  borderImageWidth: {
    ...
    "auto": StyleObject,
  } & LengthEntry & PercentEntry & { [value: number]: StyleObject } & WideEntry
  /**
  ...
  } & URLEntry & { [value: number]: StyleObject } & WideEntry
  /**
  ...
  "-ms-zoom": {
    "normal": StyleObject,
  } & PercentEntry & { [value: number]: StyleObject } & IntegerEntry & WideEntry
  /**
  ...
  "-o-border-image": {
    ...
    /** The image is stretched to fill the area. */
    "stretch": StyleObject,
  } & LengthEntry & PercentEntry & { [value: number]: StyleObject } & ImageFunctions & WideEntry
  /**
   * Specifies how the contents of a replaced element should be scaled relative to the box established by its used height and width.
   *
   * (Opera 10.6)
