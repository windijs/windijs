/**
 * This file is auto generated by 'pnpm gen:style'. Please don't edit it directly.
 *
 */
import { StyleObject, ColorEntry, LengthEntry, PercentEntry, AngleEntry, TimeEntry, WideEntry, PositionEntry, RepeatStyleEntry, LineStyleEntry, LineWidthEntry, BoxEntry, GeometryBoxEntry, ColorFunctions, ImageFunctions, BasicShapeFunctions, TransitionTimingFunctions } from "./index";
...
export interface CSSStyleData {
  ...
  motion: {
    ...
    "reverse": StyleObject,
  } & LengthEntry & PercentEntry & AngleEntry & BasicShapeFunctions & GeometryBoxEntry & WideEntry & { [key: string]: StyleObject }
  /**
  ...
  "-moz-transform": {
    ...
    "translate3d()": StyleObject,
    /** Specifies a translation by the given amount in the X direction. */
    "translateX()": StyleObject,
    /** Specifies a translation by the given amount in the Y direction. */
    "translateY()": StyleObject,
   ...
   *
   * (Edge 12, Safari 1.3, Chrome 25, Opera 9.2)
   *
   * Syntax: \<integer>
   *
   ...
   * Describes how the last line of a block or a line right before a forced line break is aligned when 'text-align' is set to 'justify'.
   *
   * (Edge 12, Firefox 49, Chrome 47, Opera 34)
   *
   ...
   * Selects the justification algorithm used when 'text-align' is set to 'justify'. The property applies to block containers, but the UA may (but is not required to) also support it on inline elements.
   *
   * (Edge 12, Firefox 55, Chrome 32, Opera 19)
   *
   ...
   *
   * (Edge 12, Safari 3.1, Chrome 1, Opera 15)
   *
