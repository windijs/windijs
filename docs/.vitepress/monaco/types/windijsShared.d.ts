...
export declare function isColor(amount: string): boolean;
export declare function isUrl(amount: string): boolean;
export declare function isPosition(amount: string): boolean;
export declare function isGradient(amount: string): boolean;
...
export declare const hasKey: <T extends Record<string, unknown>>(obj: T, k: string | number | symbol) => k is keyof T;
...
export declare function spacings<T extends Array<number>>(numbers: T): Record<T[number], string>;
