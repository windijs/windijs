...
codes.push("import { StyleObject, ColorEntry, LengthEntry, PercentEntry, AngleEntry, TimeEntry, WideEntry, PositionEntry, RepeatStyleEntry, LineStyleEntry, LineWidthEntry, BoxEntry, GeometryBoxEntry, ColorFunctions, ImageFunctions, BasicShapeFunctions, TransitionTimingFunctions } from \"./index\";");
codes.push("");
