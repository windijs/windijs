import { $var, calc, circle, ellipse, hsl, hsla, hwb, inset, linearGradient, polygon, quote, radialGradient, repeatingLinearGradient, repeatingRadialGradient, rgb, rgba, url } from "./funcs";
